...
var loginPage = /** @class */ (function () {
    ...
    loginPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-login',template:/*ion-inline-start:"C:\Users\pcalder2\Desktop\ionIc\22Escuela22\src\pages\login\login.html"*/'<ion-header>\n\n    <ion-navbar color=\'primary\'>\n\n        <ion-title>{{NombreUsuario}}</ion-title>\n\n    </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content>\n\n    <ion-item text-center>\n\n        <!---->\n\n        <ion-img class=\'ImangenLo\' width=\'200\' height=\'90\'  src="../../assets/imgs/Prueba.jpg" ></ion-img>\n\n    </ion-item>\n\n    <ion-row>\n\n        <ion-item text-center>\n\n            <ion-icon name="person" item-left></ion-icon>\n\n            <ion-input type="text" [(ngModel)]="usuario.nombre" placeholder=\'Usuario\'maxlength=\'12\' ></ion-input>\n\n            <!--<input type="text"  placeholder="Enter name here">-->\n\n            <!--<ion-input formControlName="email" type="text" placeholder="Email"></ion-input>-->\n\n        </ion-item>\n\n    </ion-row>\n\n    <ion-row>\n\n        <ion-item>\n\n            <ion-icon name="key" item-left></ion-icon>\n\n            <ion-input type="password" placeholder=\'password\' [(ngModel)]="usuario.password" maxlength=\'12\'></ion-input>\n\n            <!--<ion-input formControlName="password" type="password" placeholder="Password"></ion-input>-->\n\n        </ion-item>\n\n    </ion-row>\n\n    <ion-item text-center>\n\n            <button ion-button secondary (click)="goToHome()" [disabled]="usuario.password.length < 6">ingresar</button>\n\n    </ion-item>\n\n\n\n\n\n</ion-content>\n\n\n\n'/*ion-inline-end:"C:\Users\pcalder2\Desktop\ionIc\22Escuela22\src\pages\login\login.html"*/
        }),
...
var ListPage = /** @class */ (function () {
    ...
    ListPage = ListPage_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-list',template:/*ion-inline-start:"C:\Users\pcalder2\Desktop\ionIc\22Escuela22\src\pages\list\list.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>List</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <ion-list>\n    <button ion-item *ngFor="let item of items" (click)="itemTapped($event, item)">\n      <ion-icon [name]="item.icon" item-start></ion-icon>\n      {{item.title}}\n      <div class="item-note" item-end>\n        {{item.note}}\n      </div>\n    </button>\n  </ion-list>\n  <div *ngIf="selectedItem" padding>\n    You navigated here from <b>{{selectedItem.title}}</b>\n  </div>\n</ion-content>\n'/*ion-inline-end:"C:\Users\pcalder2\Desktop\ionIc\22Escuela22\src\pages\list\list.html"*/
        }),
...
var MyApp = /** @class */ (function () {
    function MyApp(platform, statusBar, splashScreen) {
        ...
        this.pages = [
            ...
            { title: 'Cerrar Sección', component: __WEBPACK_IMPORTED_MODULE_4__pages_login_login__["a" /* loginPage */] }
        ];
    }
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"C:\Users\pcalder2\Desktop\ionIc\22Escuela22\src\app\app.html"*/'<ion-menu color=\'primary\' [content]="content">\n  <ion-header>\n    <ion-toolbar>\n      <ion-title>Menu</ion-title>\n    </ion-toolbar>\n  </ion-header>\n\n  <ion-content>\n    <ion-list>\n      <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n        {{p.title}}\n      </button>\n    </ion-list>\n  </ion-content>\n\n</ion-menu>\n\n<!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>'/*ion-inline-end:"C:\Users\pcalder2\Desktop\ionIc\22Escuela22\src\app\app.html"*/
        }),
...
var HomePage = /** @class */ (function () {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"C:\Users\pcalder2\Desktop\ionIc\22Escuela22\src\pages\home\home.html"*/'<ion-header>\n  <ion-navbar hideBackButton="true" color=\'primary\'>\n    <button ion-button menuToggle >\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title white>\n      Titulo Papi\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n<ion-content padding>\n  <h3>Ionic Menu Starter</h3>\n  <p>If you get lost, the <a href="http://ionicframework.com/docs/v2">docs</a> will show you the way.</p>\n  <button ion-button secondary menuToggle>Toggle Menu</button>\n</ion-content>\n'/*ion-inline-end:"C:\Users\pcalder2\Desktop\ionIc\22Escuela22\src\pages\home\home.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */]])
    ], HomePage);
    return HomePage;
